...
<head>
    ...
    <title>Daftar - LeafGuard Tomato</title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-auth">
                ...
                <a href="{{ route('register') }}" class="btn-register active">DAFTAR</a>
            </div>
        </div>
    </nav>
    ...
    <main class="main-container">
        ...
        <div class="auth-container">
            <div class="auth-header">
                <h1>Daftar</h1>
                <p>Buat akun baru untuk mulai menggunakan LeafGuard</p>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validatePassword() {
                ...
                if (confirmValue === '') {
                    ...
                    confirmPassword.style.borderColor = '#e8f5e8';
